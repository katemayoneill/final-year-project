...
No optimisations: single-frame inference, CPU libx264 encode, no GPU hints.
Used as the reference timing benchmark.
"""
...
if len(sys.argv) < 2:
    print("Usage: python3 infer_base.py <video> [model.pt]")
    sys.exit(1)
...
output_path = base + "_base.mp4"
temp_path   = base + "_base_tmp.mp4"
...
while True:
    ...
    # --- single-frame inference (baseline) ---
